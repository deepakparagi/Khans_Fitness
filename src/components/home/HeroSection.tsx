  ...
  return (
    <section className="relative w-full min-h-[100svh] overflow-hidden flex flex-col pt-[64px]">
      ...
      <div className="relative z-10 px-6 lg:px-12 2xl:px-24 pt-8 lg:pt-[32px] pb-[80px] w-full max-w-[1000px] flex flex-col justify-center flex-1 items-start mt-4 lg:mt-0">
        ...
        <div className="relative z-20 flex flex-col lg:flex-row lg:items-center justify-between w-full mb-12 lg:mb-20 gap-2 lg:gap-0">
        ...
        {/* Main Heading */}
        <div ref={headingRef} className="flex flex-col font-bebas text-[clamp(40px,12vw,140px)] md:text-[clamp(40px,10vw,140px)] leading-[0.85] tracking-[-0.02em] text-left">
        ...
        <motion.p 
          ...
          className="font-inter font-light text-[15px] text-[var(--text-secondary)] mt-5 max-w-[520px] text-left"
        >
        ...
        <motion.div 
          ...
          className="flex flex-col md:flex-row flex-wrap items-start md:items-center gap-3 lg:gap-4 mt-6 lg:mt-8 w-full md:w-auto"
        >
        ...
        <motion.div 
          ...
          className="grid grid-cols-2 md:flex flex-wrap items-center gap-x-4 gap-y-4 sm:gap-8 mt-6 lg:mt-12 w-full max-w-[600px]"
        >
          <div className="flex flex-col gap-1 flex-1">
            <span className="font-bebas text-[clamp(32px,4vw,52px)] text-[var(--acid)] leading-none">500+</span>
          ...
          <div className="flex flex-col gap-1 flex-1">
            <span className="font-bebas text-[clamp(32px,4vw,52px)] text-[var(--acid)] leading-none">4.7★</span>
          ...
          <div className="flex flex-col gap-1 flex-1">
            <span className="font-bebas text-[clamp(32px,4vw,52px)] text-[var(--acid)] leading-none">6+</span>
          ...
          <div className="flex flex-col gap-1 flex-1">
            <span className="font-bebas text-[clamp(32px,4vw,52px)] text-[var(--acid)] leading-none">10+</span>
